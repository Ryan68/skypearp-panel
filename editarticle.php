				...
				<div class="row">
                    ...
                    <center>
							    ...
							    <div class="widget">
									...
									<div class="widget-content padding">
										<form class="form-vertical" role="form">
											<!-- <img src="assets/img/miniatures/<?= $a['id'] ?>.jpg" width="150" /><br /><br /> -->
                      <?php $imgpath = "assets/img/miniatures/".$a['id'].".jpg";  ?>
											...
											<a href="ajoutarticle.php?edit=<?= $a['id'] ?>"><b>Modifier</b></a> | <a href="article/supprimer.php?id=<?= $a['id'] ?>"><b>Supprimer</b></a>
										</form>
									</div>
								</div>
							</div>

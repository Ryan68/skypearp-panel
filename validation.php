...
if(isset($_POST['activer'])){
	$licence = htmlspecialchars($_POST['license']);
	activation($licence);
}

if(isset($_POST['activatenewlicense'])){
	unset($_POST['license']);
	unset($_SESSION['status']);
	unset($_POST['activer']);
	unset($_POST['activatenewlicense']);
}
...
<html>
    <head>
        ...
        <title>SkypeaRP Panel | Validation de licence</title>   
		            	...
		            	<div class="container-fluid">
				            <div class="widget">
				            	<div class="widget-header">
									<h2><strong>Validation de licence :</strong></h2>
								</div>
								<div class="widget-content padding">
									<?php if(!isset($_SESSION['status'])){ ?>
									<form method="POST">
                                    <p><center><h3><font color='black'>Licence à valider :</font></h3></center></p>
                                        <div class="form-group login-input">
                                        <input type="text" class="form-control text-input" name="license" placeholder="Votre licence" style="text-align: center;">
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                            <button type="submit" name="activer" class="btn btn-skypea btn-block">Activer</button>
                                            </div>
                                        </div>
                                    </form>
                                    <?php } ?>
									...
									<?php }elseif (isset($_SESSION['status']) AND $_SESSION['status'] == 'error') { ?>
									<div class="widget-content padding" style="text-align: center;">
										<p><font color="red"><b>Une érreur s'est produite lors de l'activation de votre licence !</b></font></p>
										<form method="POST">
											<button type="submit" name="activatenewlicense" class="btn btn-skypea">Réessayez</button>
										</form>
									</div>
									<?php } ?>
								</div>

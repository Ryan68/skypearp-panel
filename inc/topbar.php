            ...
            <div id="sidebar-menu">
                <ul>
                    <li class='has_sub'>
                        ...
                        <ul>
                            <li><a href='index.php' <?php if($_SERVER['PHP_SELF'] == '/dev/skypearp/index.php'){ echo "class='active'"; } ?> ><span>Accueil</span></a></li>
                            <li ><a href="profil.php" <?php if($_SERVER['PHP_SELF'] == '/dev/skypearp/profil.php'){ echo "class='active'"; } ?> >Profil</a></li>
                            <li ><a href="faq.php" <?php if($_SERVER['PHP_SELF'] == '/dev/skypearp/faq.php'){ echo "class='active'"; } ?> >FAQ</a></li>
                        </ul>
                    </li>
                    <li class='has_sub'>
                        <a href='javascript:void(0);'>
                        ...
                        <ul>
                            <!-- <li><a href='/skypearp/cops.php' <?php if($_SERVER['PHP_SELF'] == '/dev/skypearp/cops.php'){ echo "class='active'"; } ?> ><span>Police</span></a></li> -->
                            ...
                            <li class='has_sub'>
                                ...
                                <ul>
                                    <li class='has_sub'>
                                        ...
                                        <ul>
                                            <li><a href='recrutementcops.php' <?php if($_SERVER['PHP_SELF'] == '/dev/skypearp/recrutementcops.php'){ echo "class='active'"; } ?>><span>Recrutement</span></a></li>
                                        </ul>
                    ...
                    <li class='has_sub'>
                        ...
                        <ul>
                            <li><a href='shop.php' <?php if($_SERVER['PHP_SELF'] == '/dev/skypearp/shop.php'){ echo "class='active'"; } ?> ><span>Boutique</span></a></li>
                            <li ><a href="validation.php" <?php if($_SERVER['PHP_SELF'] == '/dev/skypearp/validation.php'){ echo "class='active'"; } ?> >Activation</a></li>
                        </ul>
                    </li>
                    ...
                    <li class='has_sub'>
                        ...
                        <ul>
                            <li ><a href="ajoutarticle.php" <?php if($_SERVER['PHP_SELF'] == '/dev/skypearp/ajoutarticle.php'){ echo "class='active'"; } ?> >Ajouter un Article</a></li>
                            <li ><a href="editarticle.php" <?php if($_SERVER['PHP_SELF'] == '/dev/skypearp/editarticle.php'){ echo "class='active'"; } ?> >Editer un Article</a></li>
                            <li ><a href="users.php" <?php if($_SERVER['PHP_SELF'] == '/dev/skypearp/users.php'){ echo "class='active'"; } ?> >Gestion utilisateurs</a></li>
                        </ul>
                    </li>
                    <?php } ?>
                </ul>

...
function cnx(){
    $dbHost = "mysql-mariadb-5-101.zap-hosting.com";        //Location Of Database usually its localhost
    $dbUser = "zap378615-1";            //Database User Name
    $dbPass = 'OIeD4HDpYBHnDQ36';            //Database Password
    $dbDatabase = "zap378615-1";    //Database Name
...
function bdd(){
    try
    {
        ...
        $bdd = new PDO('mysql:host=mysql-mariadb-5-101.zap-hosting.com;dbname=zap378615-1', 'zap378615-1', 'OIeD4HDpYBHnDQ36');
    }
    catch(Exception $e)
    {

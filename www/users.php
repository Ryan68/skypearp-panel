                                    ...
                                    <div class="widget-content padding">
                                        <form class="form-vertical" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p>Liquide : <strong><?= $a['money'] ?> <font color="lightgreen">$</font></strong></p>
                                                <p>Banque : <strong><?= $a['bank'] ?> <font color="lightgreen">$</font></strong></p>
                                                <p>Argent sale : <strong><?= $black ?> <font color="lightgreen">$</font></strong></p>
                                                <p>Sexe : <strong><?php if($a['sex'] == 'h'){ echo 'Homme'; }elseif($_SESSION['sex'] == 'f'){ echo 'Femme'; }else{ echo 'Inconnu'; } ?></strong></p>
                                                ...
                                                <p>Santé : <strong><?php if($a['isDead'] == 0){ echo '<font color="#2ecc71">VIVANT</font>'; }else{ echo '<font color="red">MORT</font>'; } ?></strong></p>
